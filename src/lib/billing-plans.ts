...
export const PLANS: PlanDef[] = [
  ...
  },
  {
    ...
    features: ["3 agentes", "2 instâncias", "5.000 mensagens/mês", "Templates ilimitados", "Suporte prioritário"],
  ...
  },
  {
    ...
    features: ["10 agentes", "5 instâncias", "30.000 mensagens/mês", "Automações avançadas", "Integrações + API"],
  ...
  },
  {
    ...
    features: ["Agentes ilimitados", "Instâncias ilimitadas", "Mensagens sob consulta", "SSO/SAML", "SLA 99,9%"],
